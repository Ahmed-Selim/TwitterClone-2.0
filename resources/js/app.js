...
app.component('profile-search-form', require('./components/ProfileSearchFormComponent.vue').default);
app.component('new-tweet-btn', require('./components/NewTweetBtnComponent.vue').default);
app.component('follow-btn', require('./components/FollowBtnComponent.vue').default);
app.component('follow-list-item', require('./components/FollowListItemComponent.vue').default);
app.component('tag-list-item', require('./components/TagListItemComponent.vue').default);
app.component('tweet', require('./components/TweetComponent.vue').default);
app.component('profile-main', require('./components/ProfileMainComponent.vue').default);
app.component('profile-sidebar', require('./components/ProfileSideBarComponent.vue').default);
app.component('follow-main', require('./components/FollowMainComponent.vue').default);
