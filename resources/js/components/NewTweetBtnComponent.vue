    ...
    <div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="align-items-baseline d-flex flex-row flex-wrap">
                        ...
                        <span class="badge badge-pill badge-primary mb-1 mx-1 text-black" style="font-size: initial;" v-for="(tag, index) in tags" v-bind:key="index">
                            #{{ tag }}&nbsp;
            ...
            <div class="modal-footer">
                ...
                <input @click="storeTweet()" type="button" class="btn btn-outline-primary btn-block" :disabled="(body == '')" value="Tweet" />
            </div>
            </div>
        </div>
        </div>
